...
When you use a function that returns a composite type, you might want only one
...
Set-returning functions can be nested in a select list, although that is not
